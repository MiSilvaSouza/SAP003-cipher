...
document.getElementById("btnCifrar").onclick = function cifrar() {
  ...
  document.getElementById("resultado").innerHTML = window.cipher.encode(Number(chave.value), mensagem.value);
};
document.getElementById("btnDecifrar").onclick = function decifrar() {
  window.cipher.decode(chave.value, mensagem.value);
  document.getElementById("resultado").innerHTML = window.cipher.decode(Number(chave.value), mensagem.value);
};